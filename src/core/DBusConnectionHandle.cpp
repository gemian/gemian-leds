...
DBusConnectionHandle::DBusConnectionHandle(std::string const& address)
{
    ScopedGError error;
...
DBusConnectionHandle::~DBusConnectionHandle()
{
    g_dbus_connection_close_sync(connection, nullptr, nullptr);
}

void DBusConnectionHandle::request_name(char const* name) const
{
...
DBusConnectionHandle::operator GDBusConnection*() const
{
    return connection;
}
